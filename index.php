...
if (!class_exists(Kirby::class)) {
    ...
    echo '<li><strong>Offline:</strong> Kirby-Release von <a href="https://github.com/getkirby/cms/releases">github.com/getkirby/cms/releases</a> laden und den Ordner <code>kirby</code> nach <code>vendor/kirby/</code> kopieren.</li>';
